...
function homework() {
    ...
    console.log("Assignment html and javascript");
    let text1 = document.getElementById("text");
    console.log(text1.textContent);

    let paragraph = document.createElement("p");
    paragraph.textContent = text1.textContent;
    ...
    text1.onmouseover = function () {
        if (counter > 1){
            paragraph2.textContent = "mouse detected: " + counter + " times";
        }else {
            paragraph2.textContent = "mouse detected";
        }
        counter++;
    };
...
function dom() {
    ...
    paragraph.onmouseover = function () {
        console.log("mouse was detected")
    };
